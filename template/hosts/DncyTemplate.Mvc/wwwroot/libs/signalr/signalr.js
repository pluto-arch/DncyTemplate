...
*/
      ...
      var Enumerator = (function () {
        ...
        Enumerator.prototype._eachEntry = function _eachEntry(hosts, i) {
          var c = this._instanceConstructor
          var resolve$$1 = c.resolve

          if (resolve$$1 === resolve$1) {
            var _then = getThen(hosts)

            if (_then === then && hosts._state !== PENDING) {
              this._settledAt(hosts._state, i, hosts._result)
            } else if (typeof _then !== 'function') {
              this._remaining--
              this._result[i] = hosts
            } else if (c === Promise$2) {
              var promise = new c(noop)
              handleMaybeThenable(promise, hosts, _then)
              this._willSettleAt(promise, i)
            } else {
              this._willSettleAt(
                new c(function (resolve$$1) {
                  return resolve$$1(hosts)
                }),
                i
              )
            }
          } else {
            this._willSettleAt(resolve$$1(hosts), i)
          }
        }
...
*/
  ...
  */
  ...
  var HttpClient_1 = createCommonjsModule(function (module, exports) {
    ...
    var HttpClient = /** @class */ (function () {
      ...
      HttpClient.prototype.get = function (url, options) {
        return this.send(
          tslib_1.__assign({}, options, { method: 'GET', url: url })
        )
      }
      HttpClient.prototype.post = function (url, options) {
        return this.send(
          tslib_1.__assign({}, options, { method: 'POST', url: url })
        )
      }
      HttpClient.prototype.delete = function (url, options) {
        return this.send(
          tslib_1.__assign({}, options, { method: 'DELETE', url: url })
        )
      }
      return HttpClient
    })()
  ...
  var HandshakeProtocol_1 = createCommonjsModule(function (module, exports) {
    ...
    var HandshakeProtocol = /** @class */ (function () {
      ...
      HandshakeProtocol.prototype.writeHandshakeRequest = function (
        ...
        return TextMessageFormat_1.TextMessageFormat.write(
      ...
      HandshakeProtocol.prototype.parseHandshakeResponse = function (data) {
        ...
        if (data instanceof ArrayBuffer) {
          ...
          var separatorIndex = binaryData.indexOf(
            TextMessageFormat_1.TextMessageFormat.RecordSeparatorCode
          )
          if (separatorIndex === -1) {
            throw new Error('Message is incomplete.')
          }
          ...
          var separatorIndex = textData.indexOf(
            TextMessageFormat_1.TextMessageFormat.RecordSeparator
          )
          if (separatorIndex === -1) {
            throw new Error('Message is incomplete.')
          }
      ...
      HubConnection.prototype.connectionClosed = function (error) {
        ...
        Object.keys(callbacks).forEach(function (key) {
          ...
          callback(
            ...
            error
              ? error
              : new Error('Invocation canceled due to connection being closed.')
          )
        })
        this.cleanupTimeout()
          ...
          return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                if (
                  transferFormat === ITransport.TransferFormat.Binary &&
              ...
              case 2:
                ...
                if (response.statusCode !== 200) {
                  ...
                  closeError = new Errors.HttpError(
                    response.statusText,
                    response.statusCode
                  )
                  this.running = false
  ...
  var ServerSentEventsTransport_1 = createCommonjsModule(function (
    module,
    exports
  ) {
    Object.defineProperty(exports, '__esModule', { value: true })
  ...
  var ServerSentEventsTransport_2 =
  ...
  var HttpConnection_1 = createCommonjsModule(function (module, exports) {
    ...
    var HttpConnection = /** @class */ (function () {
      function HttpConnection(url, options) {
        ...
        this.httpClient =
          options.httpClient || new HttpClient_1.DefaultHttpClient(this.logger)
              ...
              case 1:
                ...
                if (
                  !(
                    ...
                    ITransport.HttpTransportType.WebSockets
                  )
                )
                  return [3 /*break*/, 3]
      ...
      HttpConnection.prototype.createConnectUrl = function (url, connectionId) {
        return (
          url + (url.indexOf('?') === -1 ? '?' : '&') + ('id=' + connectionId)
        )
      }
      ...
      HttpConnection.prototype.constructTransport = function (transport) {
        switch (transport) {
          case ITransport.HttpTransportType.WebSockets:
            return new WebSocketTransport_1.WebSocketTransport(
              this.accessTokenFactory,
              this.logger,
              this.options.logMessageContent
            )
          case ITransport.HttpTransportType.ServerSentEvents:
            return new ServerSentEventsTransport_1.ServerSentEventsTransport(
              this.httpClient,
              this.accessTokenFactory,
              this.logger,
              this.options.logMessageContent
          ...
          case ITransport.HttpTransportType.LongPolling:
            return new LongPollingTransport_1.LongPollingTransport(
              this.httpClient,
              this.accessTokenFactory,
              this.logger,
              this.options.logMessageContent
      ...
      HttpConnection.prototype.resolveTransport = function (
        endpoint,
        requestedTransport,
        requestedTransferFormat
      ) {
        ...
        if (transport === null || transport === undefined) {
          ...
          if (transportMatches(requestedTransport, transport)) {
            if (transferFormats.indexOf(requestedTransferFormat) >= 0) {
              if (
                (transport === ITransport.HttpTransportType.WebSockets &&
  ...
  var HubConnectionBuilder_1 = createCommonjsModule(function (module, exports) {
    ...
    var HubConnectionBuilder = /** @class */ (function () {
      ...
      HubConnectionBuilder.prototype.build = function () {
        ...
        var connection = new HttpConnection_1.HttpConnection(
          this.url,
          httpConnectionOptions
        )
        return HubConnection_1.HubConnection.create(
          connection,
  ...
  var browserIndex = createCommonjsModule(function (module, exports) {
    ...
    // This is where we add any polyfills we'll need for the browser. It is the hosts module for browser-specific builds.
