  ...
  var n = i.layui && layui.define,
    ...
    u = {
      ...
      ready: function (e) {
        var t = 'laydate',
          a =
            (n ? 'modules/laydate/' : 'theme/') + 'default/laydate.css?v=' + u.v
  ...
  var e = (function (M) {
      ...
      (H.attr = function (e, t) {
        ...
        var n = b.attrHandle[t.toLowerCase()],
          n =
            n && z.call(b.attrHandle, t.toLowerCase()) ? n(e, t, !N) : undefined
        return n !== undefined
          ? n
          : g.attributes || !N
          ? e.getAttribute(t)
                            ...
                            : (n.addClass(m),
                              ...
                              n[0]
                                ...
                                : t.css({
                                    ...
                                    top:
                                      l.position().top + l.height() - t.height()
                                  }),
                              (s[a] = setTimeout(
                                function () {
                                  t.css({
                ...
                layui.each(t, function (e, t) {
                  ...
                  if (u[t]) {
                    var a = a ? (i = u[t](s, l)) : !u[t][0].test(s),
                      ...
                      i = i || u[t][1]
                    if (
                      ('required' === t && (i = r.attr('lay-reqText') || i), a)
                    )
                      return (
                        'tips' === o
                          ? f.tips(
                              i,
                              'string' != typeof r.attr('lay-ignore') && n
                                ? r.next()
                                : r,
                              { tips: 1 }
                            )
  ...
  var m = layui.$,
    ...
    F =
              ...
              t.colGroup ||
                ...
                (0 === t.width
                  ? i.getCssRule(o.index + '-' + t.key, function (e) {
                      e.style.width = Math.floor(a <= d ? d : a) + 'px'
                    })
                  : /\d+%$/.test(t.width) &&
                    i.getCssRule(o.index + '-' + t.key, function (e) {
                      e.style.width =
      ...
      (i.prototype.renderData = function (e) {
          ...
          o = function () {
            ...
            layui.each(i, function (o, r) {
              var a = [],
                ...
                d = [],
                c = o + y.limit * (l - 1) + 1
              ;('array' === layui.type(r) && 0 === r.length) ||
                (n || (r[b.config.indexName] = o),
                    ...
                    l.colGroup ||
                      ((t = [
                        ...
                        '<div class="layui-table-cell laytable-cell-' +
                          ...
                          (function () {
                            var e,
                              t = m.extend(!0, { LAY_INDEX: c, LAY_COL: l }, r),
        ...
        return (
          (b.cache[u.key] = i),
          u.layTotal[0 == i.length ? 'addClass' : 'removeClass'](d),
          ...
          r.eachCols(function (e, t) {
            var a,
              ...
              i =
                ...
                (l = parseFloat(c[e]).toFixed(l)),
                ((i = { LAY_COL: t })[e] = l),
                (l =
                  (t.totalRow &&
                    k.call(r, { item3: t, content: l, tplData: i })) ||
                  a),
                (n && n[t.field]) || l),
              l = [
                '<td data-field="' +
                ...
                '<div class="layui-table-cell laytable-cell-' +
                  ...
                  '"' +
                  ((l = []),
                  t.style && l.push('style="' + t.style + '"'),
                  l.join(' ')) +
                  '>' +
                  ('string' == typeof (a = t.totalRow || d.totalRow)
                    ? v(a).render(m.extend({ TOTAL_NUMS: c[e], LAY_COL: t }, t))
                    : i),
                '</div></td>'
              ].join('')
            t.field && (r.dataTotal[e] = i), o.push(l)
          }),
          r.layTotal.find('tbody').html('<tr>' + o.join('') + '</tr>'))
      }),
          ...
          r.autoSort &&
            ('asc' === e
              ...
              : ((i = layui.sort(c, b.config.indexName)),
                delete n.sortKey,
                delete r.initSort)),
          (o[r.response.dataName] = i || c),
          n.renderData({ res: o, curr: n.page, count: n.count, sort: !0 }),
          a &&
            ((r.initSort = { field: s, type: e }),
            layui.event.call(l, C, 'sort(' + d + ')', r.initSort))
      }),
      ...
      (i.prototype.events = function () {
        var d = this,
                ...
                l = function (e) {
                  ...
                  a.html(t),
                    c.height &&
                      a.css(
                        'max-height',
                        c.height - (d.layTool.outerHeight() || 50)
                      ),
              ...
              switch (
                        ...
                        layui.each(c.cols, function (a, e) {
                          layui.each(e, function (e, t) {
                            a + '-' + e === l &&
                              ...
                              (t.hide = !i),
                              d.elem
                                .find('*[data-key="' + c.index + '-' + l + '"]')
                                [i ? 'removeClass' : 'addClass'](w),
                              e != t.hide && d.setParentCol(!i, n),
                              d.resize())
                          })
                        })
                      })
                    ...
                    : l({
                        list: [
                          ...
                          t.on('click', function () {
                            ...
                            b.exportFile.call(d, c.id, null, e)
                          })
                        }
                      })
                  break
                case 'LAYTABLE_PRINT':
                  var n = window.open('about:blank', '_blank'),
                    ...
                    r = m(d.layHeader.html())
                  r.append(d.layMain.find('table').html()),
                    r.append(d.layTotal.find('table').html()),
            ...
            e
              ...
              .on('click', function (e) {
                ...
                layui.stope(e),
                  0 === a
                    ? d.sort(t, 'asc', null, !0)
                    : d.sort(t, 'desc', null, !0)
              }),
            (d.commonMember = function (e) {
              var t = m(this).parents('tr').eq(0).data('index'),
                o = d.layBody.find('tr[data-index="' + t + '"]'),
                r = (r = b.cache[d.key] || [])[t] || {}
              return m.extend(
                {
                  tr: o,
                  data: b.clearCacheKey(r),
                  del: function () {
                    ;(b.cache[d.key][t] = []), o.remove(), d.scrollPatch()
                  },
                  update: function (e) {
                    ;(e = e || {}),
                      layui.each(e, function (a, i) {
                        var l = o.children('td[data-field="' + a + '"]'),
                          n = l.children(u)
                        a in r && (r[a] = i),
                          d.eachCols(function (e, t) {
                            t.field == a &&
                              (n.html(
                                k.call(d, { item3: t, content: i, tplData: r })
                              ),
                              l.data('content', i))
                          })
                      }),
          ...
          t =
            (d.elem.on('click', 'input[name="layTableCheckbox"]+', function () {
              var e = m(this).prev(),
                t = d.layBody.find('input[name="layTableCheckbox"]'),
              ...
              e[0].disabled ||
                (l
                  ? (t.each(function (e, t) {
                      ;(t.checked = i), d.setCheckData(e, i)
                    }),
                    d.syncCheckAll(),
                    d.renderForm('checkbox'))
                  : (d.setCheckData(a, i), d.syncCheckAll()),
                layui.event.call(
                  e[0],
                  C,
                  'checkbox(' + s + ')',
            ...
            d.elem.on('click', 'input[lay-type="layTableRadio"]+', function () {
              var e = m(this).prev(),
                t = e[0].checked,
                a = b.cache[d.key],
            ...
            d.layBody
              .on('mouseenter', 'tr', function () {
                var e = m(this),
                  t = e.index()
                e.data('off') || d.layBody.find('tr:eq(' + t + ')').addClass(E)
              })
              .on('mouseleave', 'tr', function () {
                var e = m(this),
                  t = e.index()
                e.data('off') ||
                  d.layBody.find('tr:eq(' + t + ')').removeClass(E)
              })
              ...
              .on('blur', '.' + D, function () {
                ...
                d.eachCols(function (e, t) {
                  ...
                  t
                    ...
                    .html(
                      ((e = this.value),
                      k.call(d, { item3: a || {}, content: e, tplData: l }))
                    ),
                  t.parent().data('content', this.value),
                  t.remove()
              }),
            d.layBody
              .on(c.editTrigger, 'td', function (e) {
                var t = m(this),
          ...
          r =
            (d.layBody.on('click', '.' + o, function (e) {
              ...
              ;(d.tipsIndex = g.tips(
                ...
                t[0],
                {
                  ...
                  time: -1,
                  anim: -1,
                  maxWidth: p.ios || p.android ? 300 : d.elem.width() / 2,
                  isOutAnim: !1,
        ...
        d.layBody
          ...
          d.layMain.on('scroll', function () {
            var e = m(this),
              t = e.scrollLeft(),
              e = e.scrollTop()
            d.layHeader.scrollLeft(t),
              d.layTotal.scrollLeft(t),
              d.layFixed.find(T).scrollTop(e),
              g.close(d.tipsIndex)
          }),
